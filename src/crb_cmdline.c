/*
  ...
  gengetopt --func-name=crb_cmdline_parser --file-name=crb_cmdline --include-getopt       --unamed-opts=APPLICATION STRING --no-handle-error
...
const char *gengetopt_args_info_purpose = "RNA analysis";

const char *gengetopt_args_info_usage = "Usage: corb [OPTIONS]... APPLICATION [OPTIONS]...";

const char *gengetopt_args_info_description = "Collection of RNAanalysis Binaries\n             available tools:\n             brot:  Basic RNA Optimisation Tool\n             fold:  Prediction of RNA Secondary Structures\n             er2de: Evaluating RNA 2D energy";
...
void
crb_cmdline_parser_print_version (void)
{
  printf ("%s %s\n", CRB_CMDLINE_PARSER_PACKAGE, CRB_CMDLINE_PARSER_VERSION);
}

static void print_help_common(void) {
  crb_cmdline_parser_print_version ();
...
void
crb_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
...
void
crb_cmdline_parser_init (struct gengetopt_args_info *args_info)
{
...
void
crb_cmdline_parser_params_init(struct crb_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct crb_cmdline_parser_params *
crb_cmdline_parser_params_create(void)
{
  struct crb_cmdline_parser_params *params = 
    (struct crb_cmdline_parser_params *)malloc(sizeof(struct crb_cmdline_parser_params));
  crb_cmdline_parser_params_init(params);  
  return params;
}
...
static void
crb_cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  unsigned int i;
...
int
crb_cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", CRB_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
crb_cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", CRB_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = crb_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
crb_cmdline_parser_free (struct gengetopt_args_info *args_info)
{
  crb_cmdline_parser_release (args_info);
}
...
int
crb_cmdline_parser (int argc, char **argv, struct gengetopt_args_info *args_info)
{
  return crb_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
crb_cmdline_parser_ext (int argc, char **argv, struct gengetopt_args_info *args_info,
                   struct crb_cmdline_parser_params *params)
{
  int result;
  result = crb_cmdline_parser_internal (argc, argv, args_info, params, 0);

  return result;
}

int
crb_cmdline_parser2 (int argc, char **argv, struct gengetopt_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct crb_cmdline_parser_params params;
...
int
crb_cmdline_parser_required (struct gengetopt_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
                        ...
                        struct crb_cmdline_parser_params *params, const char *additional_error)
{
  ...
  crb_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          crb_cmdline_parser_print_help ();
          crb_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", CRB_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  crb_cmdline_parser_release (&local_args_info);
