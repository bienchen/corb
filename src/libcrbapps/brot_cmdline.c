/*
  ...
  gengetopt -i brot.ggo --string-parser --func-name=brot_cmdline_parser --file-name=brot_cmdline --include-getopt --unamed-opts=STRUCTURE --arg-struct-name=brot_args_info --no-handle-error
...
init_help_array(void)
{
  ...
  brot_args_info_help[4] = 0; 
  
}

const char *brot_args_info_help[5];
...
{
  int result;
  result = brot_cmdline_parser_internal (argc, argv, args_info, params, NULL);
  ...
  while (1)
    {
      ...
      if (update_arg((void *)&((*list)->arg), &((*list)->orig), 0,
          prev_given, multi_token, possible_values, arg_type,
                     0, 1, 1, 1, long_opt, short_opt, additional_error)) {
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVn:", long_options, &option_index);
