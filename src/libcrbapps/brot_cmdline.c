/*
  ...
  gengetopt --string-parser --func-name=brot_cmdline_parser --file-name=brot_cmdline --include-getopt --unamed-opts=STRUCTURE --arg-struct-name=brot_args_info --no-handle-error
...
const char *brot_args_info_purpose = "Designing RNA sequences using SCMF.";

const char *brot_args_info_usage = "Usage: brot [OPTIONS]... STRUCTURE";

const char *brot_args_info_description = "Basic RNAsequence Optimisation Tool";
...
{
  brot_args_info_help[0] = brot_args_info_detailed_help[0];
...
static
void clear_given (struct brot_args_info *args_info);
static
...
static int
brot_cmdline_parser_required2 (struct brot_args_info *args_info, const char *prog_name, const char *additional_error);
struct line_list
{
  char * string_arg;
...
const char *brot_cmdline_parser_scoring_values[] = {"NN", "nussinov", "simpleNN", 0}; /*< Possible values for scoring. */
...
void
brot_cmdline_parser_print_version (void)
{
  printf ("%s %s\n", BROT_CMDLINE_PARSER_PACKAGE, BROT_CMDLINE_PARSER_VERSION);
}

static void print_help_common(void) {
  brot_cmdline_parser_print_version ();

  if (strlen(brot_args_info_purpose) > 0)
    printf("\n%s\n", brot_args_info_purpose);

  if (strlen(brot_args_info_usage) > 0)
    printf("\n%s\n", brot_args_info_usage);

  printf("\n");

  if (strlen(brot_args_info_description) > 0)
    printf("%s\n\n", brot_args_info_description);
}

void
brot_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
...
void
brot_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (brot_args_info_detailed_help[i])
    printf("%s\n", brot_args_info_detailed_help[i++]);
}

void
brot_cmdline_parser_init (struct brot_args_info *args_info)
{
...
void
brot_cmdline_parser_params_init(struct brot_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
brot_cmdline_parser_params_create(void)
{
  struct brot_cmdline_parser_params *params = 
    (struct brot_cmdline_parser_params *)malloc(sizeof(struct brot_cmdline_parser_params));
  brot_cmdline_parser_params_init(params);  
  return params;
}
...
int
brot_cmdline_parser_dump(FILE *outfile, struct brot_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->negative_design_scaling_given)
...
int
brot_cmdline_parser_file_save(const char *filename, struct brot_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", BROT_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = brot_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
brot_cmdline_parser_free (struct brot_args_info *args_info)
{
  brot_cmdline_parser_release (args_info);
}
...
{
  int result;
  result = brot_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
brot_cmdline_parser_required (struct brot_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (brot_cmdline_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
...
brot_cmdline_parser_required2 (struct brot_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->fixed_nuc_given, args_info->fixed_nuc_min, args_info->fixed_nuc_max, "'--fixed-nuc' ('-n')"))
     error = 1;
 ...
 * @param check_ambiguity @see brot_cmdline_parser_params.check_ambiguity
 * @param override @see brot_cmdline_parser_params.override
                        ...
                        struct brot_cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * fixed_nuc_list = NULL;
  int error = 0;
  struct brot_args_info local_args_info;
  ...
  if (initialize)
    brot_cmdline_parser_init (args_info);

  brot_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'r':	/* Random seed.  */
          ...
          break;
        case 'd':	/* Scale negative design term.  */
          ...
          break;
        case 'h':	/* Scale heterogenity term.  */
        ...
        case 'j':	/* Minimal cooling factor.  */
          ...
          if (update_arg( (void *)&(args_info->min_cool_arg), 
              ...
              &(local_args_info.min_cool_given), optarg, 0, "0.866", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "min-cool", 'j',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "help") == 0) {
            brot_cmdline_parser_print_help ();
            brot_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", BROT_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */


  update_multiple_arg((void *)&(args_info->fixed_nuc_arg),
    &(args_info->fixed_nuc_orig), args_info->fixed_nuc_given,
    local_args_info.fixed_nuc_given, 0,
    ARG_STRING, fixed_nuc_list);

  args_info->fixed_nuc_given += local_args_info.fixed_nuc_given;
  local_args_info.fixed_nuc_given = 0;
  
  if (check_required)
    {
      error += brot_cmdline_parser_required2 (args_info, argv[0], additional_error);
    }

  brot_cmdline_parser_release (&local_args_info);
...
static unsigned int
brot_cmdline_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
brot_cmdline_parser_string(const char *cmdline, struct brot_args_info *args_info, const char *prog_name)
{
  return brot_cmdline_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
brot_cmdline_parser_string2(const char *cmdline, struct brot_args_info *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return brot_cmdline_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
brot_cmdline_parser_string_ext(const char *cmdline, struct brot_args_info *args_info, const char *prog_name,
    struct brot_cmdline_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = brot_cmdline_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    brot_cmdline_parser_internal (argc, argv_ptr, args_info, params, 0);
