/*
  ...
  gengetopt --string-parser --func-name=er2de_cmdline_parser --file-name=er2de_cmdline --include-getopt --unamed-opts=STRUCTURE --arg-struct-name=er2de_args_info --no-handle-error
...
const char *er2de_args_info_purpose = "Evaluating RNA 2D energy";

const char *er2de_args_info_usage = "Usage: er2de [OPTIONS]... SEQUENCE STRUCTURE";

const char *er2de_args_info_description = "Calculation of the free energy of a given RNA secondary structure";

const char *er2de_args_info_detailed_help[] = {
  ...
  "  Use a certain energy model to score the RNA structure.                 \n  Possible NAMEs are `NN' and `nussinov'. `nussinov' uses                 a \n  Nussinov model, only counting Hbonds. `NN' invokes the                 \n  Nearest Neighbour model.",
    0
};
...
{
  er2de_args_info_help[0] = er2de_args_info_detailed_help[0];
  er2de_args_info_help[1] = er2de_args_info_detailed_help[1];
  er2de_args_info_help[2] = er2de_args_info_detailed_help[2];
  er2de_args_info_help[3] = er2de_args_info_detailed_help[3];
  er2de_args_info_help[4] = 0; 
  
}

const char *er2de_args_info_help[5];

typedef enum {ARG_NO
  , ARG_ENUM
} er2de_cmdline_parser_arg_type;

static
void clear_given (struct er2de_args_info *args_info);
static
void clear_args (struct er2de_args_info *args_info);

static int
er2de_cmdline_parser_internal (int argc, char **argv, struct er2de_args_info *args_info,
                        struct er2de_cmdline_parser_params *params, const char *additional_error);
...
const char *er2de_cmdline_parser_scoring_values[] = {"NN", "nussinov", 0}; /*< Possible values for scoring. */
...
static
void init_args_info(struct er2de_args_info *args_info)
{

  init_help_array(); 
  args_info->help_help = er2de_args_info_detailed_help[0] ;
  args_info->detailed_help_help = er2de_args_info_detailed_help[1] ;
  args_info->version_help = er2de_args_info_detailed_help[2] ;
  args_info->scoring_help = er2de_args_info_detailed_help[3] ;
  
}

void
er2de_cmdline_parser_print_version (void)
{
  printf ("%s %s\n", ER2DE_CMDLINE_PARSER_PACKAGE, ER2DE_CMDLINE_PARSER_VERSION);
}

static void print_help_common(void) {
  er2de_cmdline_parser_print_version ();

  if (strlen(er2de_args_info_purpose) > 0)
    printf("\n%s\n", er2de_args_info_purpose);

  if (strlen(er2de_args_info_usage) > 0)
    printf("\n%s\n", er2de_args_info_usage);

  printf("\n");

  if (strlen(er2de_args_info_description) > 0)
    printf("%s\n\n", er2de_args_info_description);
}

void
er2de_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (er2de_args_info_help[i])
    printf("%s\n", er2de_args_info_help[i++]);
}

void
er2de_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (er2de_args_info_detailed_help[i])
    printf("%s\n", er2de_args_info_detailed_help[i++]);
}

void
er2de_cmdline_parser_init (struct er2de_args_info *args_info)
{
...
void
er2de_cmdline_parser_params_init(struct er2de_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct er2de_cmdline_parser_params *
er2de_cmdline_parser_params_create(void)
{
  struct er2de_cmdline_parser_params *params = 
    (struct er2de_cmdline_parser_params *)malloc(sizeof(struct er2de_cmdline_parser_params));
  er2de_cmdline_parser_params_init(params);  
  return params;
}
...
static void
er2de_cmdline_parser_release (struct er2de_args_info *args_info)
{
  unsigned int i;
...
int
er2de_cmdline_parser_dump(FILE *outfile, struct er2de_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", ER2DE_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->scoring_given)
    write_into_file(outfile, "scoring", args_info->scoring_orig, er2de_cmdline_parser_scoring_values);
...
int
er2de_cmdline_parser_file_save(const char *filename, struct er2de_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", ER2DE_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = er2de_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
er2de_cmdline_parser_free (struct er2de_args_info *args_info)
{
  er2de_cmdline_parser_release (args_info);
}
...
int
er2de_cmdline_parser (int argc, char **argv, struct er2de_args_info *args_info)
{
  return er2de_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
er2de_cmdline_parser_ext (int argc, char **argv, struct er2de_args_info *args_info,
                   struct er2de_cmdline_parser_params *params)
{
  int result;
  result = er2de_cmdline_parser_internal (argc, argv, args_info, params, 0);

  return result;
}

int
er2de_cmdline_parser2 (int argc, char **argv, struct er2de_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct er2de_cmdline_parser_params params;
...
int
er2de_cmdline_parser_required (struct er2de_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see er2de_cmdline_parser_params.check_ambiguity
 * @param override @see er2de_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               er2de_cmdline_parser_arg_type arg_type,
...
int
er2de_cmdline_parser_internal (
  int argc, char **argv, struct er2de_args_info *args_info,
                        struct er2de_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error = 0;
  struct er2de_args_info local_args_info;
  ...
  if (initialize)
    er2de_cmdline_parser_init (args_info);

  er2de_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          er2de_cmdline_parser_print_help ();
          er2de_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        case 'c':	/* Choose a different scoring scheme.  */
          ...
          if (update_arg( (void *)&(args_info->scoring_arg), 
              ...
              &(local_args_info.scoring_given), optarg, er2de_cmdline_parser_scoring_values, "NN", ARG_ENUM,
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            er2de_cmdline_parser_print_detailed_help ();
            er2de_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", ER2DE_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  er2de_cmdline_parser_release (&local_args_info);
...
static unsigned int
er2de_cmdline_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
er2de_cmdline_parser_string(const char *cmdline, struct er2de_args_info *args_info, const char *prog_name)
{
  return er2de_cmdline_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
er2de_cmdline_parser_string2(const char *cmdline, struct er2de_args_info *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return er2de_cmdline_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
er2de_cmdline_parser_string_ext(const char *cmdline, struct er2de_args_info *args_info, const char *prog_name,
    struct er2de_cmdline_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = er2de_cmdline_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    er2de_cmdline_parser_internal (argc, argv_ptr, args_info, params, 0);
