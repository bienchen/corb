/*
  ...
  gengetopt --string-parser --func-name=fold_cmdline_parser --file-name=fold_cmdline --include-getopt --unamed-opts=SEQUENCE --arg-struct-name=fold_args_info --no-handle-error
...
const char *fold_args_info_purpose = "Predicting the secondary structure of RNA sequences.";

const char *fold_args_info_usage = "Usage: fold [OPTIONS]... SEQUENCE";

const char *fold_args_info_description = "Prediction Tool for RNA Secondary Structures without Pseudoknots";

const char *fold_args_info_detailed_help[] = {
  "  -h, --help             Print help and exit",
  "      --detailed-help    Print help, including all details and hidden options, \n                           and exit",
  "  -V, --version          Print version and exit",
  "  -l, --loop-length=INT  Minimal length of loops  (default=`4')",
  "  Sets a threshold for the minimal loop length.",
    0
};
...
{
  fold_args_info_help[0] = fold_args_info_detailed_help[0];
  fold_args_info_help[1] = fold_args_info_detailed_help[1];
  fold_args_info_help[2] = fold_args_info_detailed_help[2];
  fold_args_info_help[3] = fold_args_info_detailed_help[3];
  fold_args_info_help[4] = 0; 
  
}

const char *fold_args_info_help[5];

typedef enum {ARG_NO
  , ARG_LONG
} fold_cmdline_parser_arg_type;

static
void clear_given (struct fold_args_info *args_info);
static
void clear_args (struct fold_args_info *args_info);

static int
fold_cmdline_parser_internal (int argc, char **argv, struct fold_args_info *args_info,
                        struct fold_cmdline_parser_params *params, const char *additional_error);
...
void clear_given (struct fold_args_info *args_info)
{
  ...
  args_info->loop_length_given = 0 ;
}

static
void clear_args (struct fold_args_info *args_info)
{
  args_info->loop_length_arg = 4;
  args_info->loop_length_orig = NULL;
  
}

static
void init_args_info(struct fold_args_info *args_info)
{

  init_help_array(); 
  args_info->help_help = fold_args_info_detailed_help[0] ;
  args_info->detailed_help_help = fold_args_info_detailed_help[1] ;
  args_info->version_help = fold_args_info_detailed_help[2] ;
  args_info->loop_length_help = fold_args_info_detailed_help[3] ;
  
}

void
fold_cmdline_parser_print_version (void)
{
  printf ("%s %s\n", FOLD_CMDLINE_PARSER_PACKAGE, FOLD_CMDLINE_PARSER_VERSION);
}

static void print_help_common(void) {
  fold_cmdline_parser_print_version ();

  if (strlen(fold_args_info_purpose) > 0)
    printf("\n%s\n", fold_args_info_purpose);

  if (strlen(fold_args_info_usage) > 0)
    printf("\n%s\n", fold_args_info_usage);

  printf("\n");

  if (strlen(fold_args_info_description) > 0)
    printf("%s\n", fold_args_info_description);
}

void
fold_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (fold_args_info_help[i])
    printf("%s\n", fold_args_info_help[i++]);
}

void
fold_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (fold_args_info_detailed_help[i])
    printf("%s\n", fold_args_info_detailed_help[i++]);
}

void
fold_cmdline_parser_init (struct fold_args_info *args_info)
{
...
void
fold_cmdline_parser_params_init(struct fold_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct fold_cmdline_parser_params *
fold_cmdline_parser_params_create(void)
{
  struct fold_cmdline_parser_params *params = 
    (struct fold_cmdline_parser_params *)malloc(sizeof(struct fold_cmdline_parser_params));
  fold_cmdline_parser_params_init(params);  
  return params;
}
...
static void
fold_cmdline_parser_release (struct fold_args_info *args_info)
{
  unsigned int i;
  free_string_field (&(args_info->loop_length_orig));
...
int
fold_cmdline_parser_dump(FILE *outfile, struct fold_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", FOLD_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
  ...
  if (args_info->loop_length_given)
    write_into_file(outfile, "loop-length", args_info->loop_length_orig);
...
int
fold_cmdline_parser_file_save(const char *filename, struct fold_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", FOLD_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = fold_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
fold_cmdline_parser_free (struct fold_args_info *args_info)
{
  fold_cmdline_parser_release (args_info);
}
...
int
fold_cmdline_parser (int argc, char **argv, struct fold_args_info *args_info)
{
  return fold_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
fold_cmdline_parser_ext (int argc, char **argv, struct fold_args_info *args_info,
                   struct fold_cmdline_parser_params *params)
{
  int result;
  result = fold_cmdline_parser_internal (argc, argv, args_info, params, NULL);

  return result;
}

int
fold_cmdline_parser2 (int argc, char **argv, struct fold_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct fold_cmdline_parser_params params;
...
int
fold_cmdline_parser_required (void)
{
  return EXIT_SUCCESS;
}
 ...
 * @param check_ambiguity @see fold_cmdline_parser_params.check_ambiguity
 * @param override @see fold_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               fold_cmdline_parser_arg_type arg_type,
                        ...
                        struct fold_cmdline_parser_params *params, const char *additional_error)
{
  ...
  int error = 0;
  struct fold_args_info local_args_info;
  ...
  if (initialize)
    fold_cmdline_parser_init (args_info);

  fold_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          fold_cmdline_parser_print_help ();
          fold_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        case 'l':	/* Minimal length of loops.  */
        
        
          if (update_arg( (void *)&(args_info->loop_length_arg), 
               &(args_info->loop_length_orig), &(args_info->loop_length_given),
              &(local_args_info.loop_length_given), optarg, 0, ARG_LONG,
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            fold_cmdline_parser_print_detailed_help ();
            fold_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", FOLD_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  fold_cmdline_parser_release (&local_args_info);
...
static unsigned int
fold_cmdline_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
fold_cmdline_parser_string(const char *cmdline, struct fold_args_info *args_info, const char *prog_name)
{
  return fold_cmdline_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
fold_cmdline_parser_string2(const char *cmdline, struct fold_args_info *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return fold_cmdline_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
fold_cmdline_parser_string_ext(const char *cmdline, struct fold_args_info *args_info, const char *prog_name,
    struct fold_cmdline_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = fold_cmdline_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    fold_cmdline_parser_internal (argc, argv_ptr, args_info, params, 0);
