/*
  ...
  gengetopt --string-parser --func-name=salat_cmdline_parser --file-name=salat_cmdline --include-getopt --unamed-opts=STRUCTURE --arg-struct-name=salat_args_info --no-handle-error
...
const char *salat_args_info_purpose = "Simply annotate Loop-assembly Topologies";

const char *salat_args_info_usage = "Usage: salat [OPTIONS]... STRUCTURE";

const char *salat_args_info_description = "Enumerate loops of an RNA secondary structure";

const char *salat_args_info_detailed_help[] = {
...
{
  salat_args_info_help[0] = salat_args_info_detailed_help[0];
...
typedef enum {ARG_NO
  , ARG_LONG
} salat_cmdline_parser_arg_type;

static
void clear_given (struct salat_args_info *args_info);
static
...
static int
salat_cmdline_parser_required2 (struct salat_args_info *args_info, const char *prog_name, const char *additional_error);
struct line_list
{
  char * string_arg;
...
void clear_args (struct salat_args_info *args_info)
{
  ...
  args_info->position_arg = NULL;
  args_info->position_orig = NULL;
  
}

static
void init_args_info(struct salat_args_info *args_info)
{
...
void
salat_cmdline_parser_print_version (void)
{
  printf ("%s %s\n", SALAT_CMDLINE_PARSER_PACKAGE, SALAT_CMDLINE_PARSER_VERSION);
}

static void print_help_common(void) {
  salat_cmdline_parser_print_version ();

  if (strlen(salat_args_info_purpose) > 0)
    printf("\n%s\n", salat_args_info_purpose);

  if (strlen(salat_args_info_usage) > 0)
    printf("\n%s\n", salat_args_info_usage);

  printf("\n");

  if (strlen(salat_args_info_description) > 0)
    printf("%s\n\n", salat_args_info_description);
}

void
salat_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (salat_args_info_help[i])
    printf("%s\n", salat_args_info_help[i++]);
}

void
salat_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (salat_args_info_detailed_help[i])
    printf("%s\n", salat_args_info_detailed_help[i++]);
}

void
salat_cmdline_parser_init (struct salat_args_info *args_info)
{
...
void
salat_cmdline_parser_params_init(struct salat_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
struct salat_cmdline_parser_params *
salat_cmdline_parser_params_create(void)
{
  struct salat_cmdline_parser_params *params = 
    (struct salat_cmdline_parser_params *)malloc(sizeof(struct salat_cmdline_parser_params));
  salat_cmdline_parser_params_init(params);  
  return params;
}
...
static void
salat_cmdline_parser_release (struct salat_args_info *args_info)
{
  unsigned int i;
  free_multiple_field (args_info->position_given, (void *)(args_info->position_arg), &(args_info->position_orig));
  args_info->position_arg = 0;
...
int
salat_cmdline_parser_dump(FILE *outfile, struct salat_args_info *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", SALAT_CMDLINE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
salat_cmdline_parser_file_save(const char *filename, struct salat_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", SALAT_CMDLINE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = salat_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
salat_cmdline_parser_free (struct salat_args_info *args_info)
{
  salat_cmdline_parser_release (args_info);
}
...
{
  int result;
  result = salat_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
salat_cmdline_parser_required (struct salat_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (salat_cmdline_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
...
salat_cmdline_parser_required2 (struct salat_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->position_given, args_info->position_min, args_info->position_max, "'--position' ('-p')"))
     error = 1;
 ...
 * @param check_ambiguity @see salat_cmdline_parser_params.check_ambiguity
 * @param override @see salat_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               salat_cmdline_parser_arg_type arg_type,
                        ...
                        struct salat_cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * position_list = NULL;
  int error = 0;
  ...
  salat_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          salat_cmdline_parser_print_help ();
        ...
        case 'p':	/* Only get information for a certain position.  */
          ...
          if (update_multiple_arg_temp(&position_list, 
              &(local_args_info.position_given), optarg, 0, 0, ARG_LONG,
              "position", 'p',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            salat_cmdline_parser_print_detailed_help ();
            salat_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", SALAT_CMDLINE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */


  update_multiple_arg((void *)&(args_info->position_arg),
    &(args_info->position_orig), args_info->position_given,
    local_args_info.position_given, 0,
    ARG_LONG, position_list);

  args_info->position_given += local_args_info.position_given;
  local_args_info.position_given = 0;
  
  if (check_required)
    {
      error += salat_cmdline_parser_required2 (args_info, argv[0], additional_error);
    }

  salat_cmdline_parser_release (&local_args_info);
...
static unsigned int
salat_cmdline_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
salat_cmdline_parser_string(const char *cmdline, struct salat_args_info *args_info, const char *prog_name)
{
  return salat_cmdline_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
salat_cmdline_parser_string2(const char *cmdline, struct salat_args_info *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return salat_cmdline_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
salat_cmdline_parser_string_ext(const char *cmdline, struct salat_args_info *args_info, const char *prog_name,
    struct salat_cmdline_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = salat_cmdline_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    salat_cmdline_parser_internal (argc, argv_ptr, args_info, params, 0);
