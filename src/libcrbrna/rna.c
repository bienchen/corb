...
/** @brief Get the secondary structure component of an Rna object.
 *
 * Get the SecStruct object stored with a Rna object. If no SecStruct was set
 * before, returns @c NULL.
 *
 * @params[in] this Rna data object.
 */
SecStruct*
rna_get_secstruct (const Rna* this)
{
   assert (this);
